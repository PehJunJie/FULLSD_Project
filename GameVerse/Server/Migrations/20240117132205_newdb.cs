    ...
    public partial class newdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "System", new DateTime(2024, 1, 17, 21, 22, 5, 315, DateTimeKind.Local).AddTicks(6285), new DateTime(2024, 1, 17, 21, 22, 5, 315, DateTimeKind.Local).AddTicks(6300), "I love playing Honkai: Star Rail!", "System" },
                    { 2, new DateTime(2024, 1, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "System", new DateTime(2024, 1, 17, 21, 22, 5, 315, DateTimeKind.Local).AddTicks(6303), new DateTime(2024, 1, 17, 21, 22, 5, 315, DateTimeKind.Local).AddTicks(6304), "LE SSERAFIM x Overwatch2 collab is sick!", "System" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "System", new DateTime(2024, 1, 17, 21, 22, 5, 315, DateTimeKind.Local).AddTicks(6629), new DateTime(2024, 1, 17, 21, 22, 5, 315, DateTimeKind.Local).AddTicks(6629), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 7.0, "The game provides a lot of freebies, leveling up every quickly without spending money.", "System" },
                    { 2, null, "System", new DateTime(2024, 1, 17, 21, 22, 5, 315, DateTimeKind.Local).AddTicks(6632), new DateTime(2024, 1, 17, 21, 22, 5, 315, DateTimeKind.Local).AddTicks(6632), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 8.5, "I initially have no high expectation for the game but it turns out the game is pretty good.", "System" }
                });
